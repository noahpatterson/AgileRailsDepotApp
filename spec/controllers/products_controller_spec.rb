  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product" do
        ...
        Product.any_instance.should_receive(:update).with({ "title" => "MyString", 'description' => 'things', 'image_url' => 'a.jpg', 'price' => "0.99" })
        put :update, {:id => product.to_param, :product => { "title" => "MyString", 'description' => 'things', 'image_url' => 'a.jpg', 'price' => 0.99 }}, valid_session
      end
