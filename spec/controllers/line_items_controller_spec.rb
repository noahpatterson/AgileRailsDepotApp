  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved line_item as @line_item" do
        ...
        post :create, {:line_item => { "product" => "invalid value" }, product_id: product.id}, valid_session
        assigns(:line_item).should be_a_new(LineItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested line_item" do
        ...
        put :update, {:id => line_item.to_param, :line_item => { "product_id" => product.id}}, valid_session
      end
